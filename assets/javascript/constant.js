...
"lobster" : ["light merlot", "french burgandy", "white burgandy", "sauvignon blanc"],
...
var varietals = {
  ...
  "sauvignon blanc": ["lobster", "crab", "chicken", "salmon", "tuna"],
...
var varietalInfo = {
  ...
  "barolo": ["Barolo is a red wine produced in the northern Italian region of Piedmont. It is made from the Nebbiolo grape and is often described as one of Italy's greatest wines."],
  ...
  "prosecco": ["Prosecco is an Italian white wine. Prosecco DOC can be spumante ('sparkling wine'), frizzante ('semi-sparkling wine'), or tranquillo ('still wine'), depending on the perlage. It is made from Glera grapes, formerly known also as Prosecco, but other grape varieties may be included. "],
