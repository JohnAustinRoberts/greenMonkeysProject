...
var varietalInfo = {
  ...
  "prosecco": ["Prosecco (/prəˈsɛkoʊ, proʊ-/,[1][2] Italian: [proˈsekko]) is an Italian white wine. Prosecco DOC can be spumante ('sparkling wine'), frizzante ('semi-sparkling wine'), or tranquillo ('still wine'), depending on the perlage.[3] It is made from Glera grapes, formerly known also as Prosecco, but other grape varieties may be included. "],
